            ...
            <div id="board1_detail_inner_comments">
                ...
                <c:if test="${empty commentList }">
                    ...
                    <c:if test="${!empty commentList }">
                        ...
                        <c:choose>
                        <c:when test="${seq==comment.seq }" >
                        <form action="board1_comment_updateProc.action" method="post">
                        
                            <input type="hidden" name="seq" value="${comment.seq }"/>
                            <input type="hidden" name="fSeq" value="${comment.fSeq }"/>
                            ...
                            <div class="board1_detail_inner_comments_leftAndRight">
                                <div class="board1_detail_inner_comments_left">
                                    ...
                                    <div id="board1_detail_inner_comments_comment_textarea"><textarea name ="text" rows="5">${comment.text}</textarea></div>
                                </div>
                                <div class="board1_detail_inner_comments_right">
                                    <div id="board1_detail_inner_comments_save"><button type="submit">저장</button></div>
                                    <div id="board1_detail_inner_comments_cancle"><a href="board1_detail.action?sort=${sort }&search=${search}&seq=${comment.fSeq}">취소</a></div>
                                </div>
                           </div>
                        </form>
                       </c:when>
